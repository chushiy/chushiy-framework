 ...
 * @Version 1.0
 */
public class ChuShiyMybatisPlusConfig {
    ...
    public GlobalConfig globalConfig() {
        ...
        // 逻辑已删除值
        dbConfig.setLogicDeleteValue(DeleteFlagEnum.DELETE.getCode());
        // 逻辑未删除值
        dbConfig.setLogicNotDeleteValue(DeleteFlagEnum.NORMAL.getCode());
